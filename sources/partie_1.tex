...
\textbf{Loïc Ségalou} est un membre de l'association. Développeur informatique, il a la maitrise technique pour représenter LiberTIC durant la conception de l'application.

\textbf{Aleth Gueguen} est une utilisatrice de la première version d'ODE et permet d'exprimer les besoins exterieurs nécessaire à l'application de son point de vue. Elle serait consommatrice de l'API mise en place, pour promouvoir les événements publiés sur son site: \url{http://lereacteur.info}.
